    ...
    <table class="table table-hover">
        ...
        <c:forEach items="${assetsAdds1}" var="ass" varStatus="vc">
            <tr>
                ...
                <td>${ass.assetsAdd_user}</td>
                <td>
                        <a href="<%=basePath%>assets/show?id=${ass.id}" style="color: #dea726"> 查看</a>
                        <a href="<%=basePath%>assets/upate1?id=${ass.id}" style="color: #dea726"> 修改</a>
                        <a href="<%=basePath%>assets/del?id=${ass.id}" style="color: #dea726"> 删除</a></td>
