...
<div>
    <table class="table table-hover">
        ...
        <th>备注</th>
        <tr>
            <td>${assetsAdd.assetsAdd_name}</td>
            <td><a href="<%=basePath%>/assetsClass/show" style="color: #dea726">${assetsAdd.assetsAdd_class}</a></td>
            <td>${assetsAdd.assetsAdd_time}</td>
            <td>${assetsAdd.assetsAdd_user}</td>
            <td>${assetsAdd.assetsAdd_msg}</td>
        </tr>
